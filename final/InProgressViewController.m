...
#import "CustomProgressTableViewCell.h"
...
- (void)viewDidLoad {
    ...
    NSData *savedData = [_defultProgress objectForKey:@"ProgressTasks"];
    if (savedData != nil) {
        NSError *error;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    CustomProgressTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"progressCell"];
...
//            }
//        } else {
//            taskToDelete = _arr[indexPath.row];
...
//
//        if (_isSorted) {
//            [updatedTasks addObjectsFromArray:_highPriority];
//            [updatedTasks addObjectsFromArray:_mediumPriority];
//            [updatedTasks addObjectsFromArray:_lowPriority];
//        } else {
//            [updatedTasks addObjectsFromArray:_arr];
//        }
//
//        NSError *error;
//        NSData *archiveData = [NSKeyedArchiver archivedDataWithRootObject:updatedTasks requiringSecureCoding:YES error:&error];
//        if (!error) {
//            [_defultProgress setObject:archiveData forKey:@"ProgressTasks"];
//            [_defultProgress synchronize];
//        }
//
...
- (void)showAlert:(NSIndexPath *)indexPath tableView:(UITableView *)tableView{
    ...
    UIAlertAction *delete = [UIAlertAction actionWithTitle:@"Delete" style:UIAlertActionStyleDestructive handler:^(UIAlertAction * _Nonnull action) {
        ...
        NSData *archiveData = [NSKeyedArchiver archivedDataWithRootObject:updatedTasks requiringSecureCoding:YES error:&error];
        if (!error) {
            [self->_defultProgress setObject:archiveData forKey:@"ProgressTasks"];
            [self->_defultProgress synchronize];
        }
